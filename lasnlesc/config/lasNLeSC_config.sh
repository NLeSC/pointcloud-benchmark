...
export LIBLAS_HOME=$LIBLAS17_HOME
export LASZIP_HOME=$LASZIP21_HOME
...
export LDFLAGS="${LDFLAGS} -L$BOOST_HOME/lib -L$LIBLAS_HOME/lib -L$LASZIP_HOME/lib -llas_c -llaszip -lpthread"
